...
class TaskEditViewController: UIViewController {
    ...
    private func setup() {
        ...
        if let taskToEdit = possibleTaskToEdit {
            ...
            taskEditView.bind(nameTextFieldText: taskToEdit.name, projectTextFieldText: taskToEdit.project.name/*, employeeTextFieldText: taskToEdit.employee, statusTextFieldText: taskToEdit.status, requiredNumberOfHoursTextFieldText: taskToEdit.requiredNumberOfHours, startDateTextFieldText: taskToEdit.startDate, endDateTextFieldText: taskToEdit.endDate*/)
        } else {
